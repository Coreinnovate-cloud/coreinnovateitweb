      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                <h2 className="text-2xl font-bold font-dm-sans text-black">
                  1. Information We Collect
                </h2>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 ml-4">
                      ...
                      <li className="flex items-start gap-3 text-black">
                        <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          Request quotes or information about our services
                        </span>
                      </li>
                      <li className="flex items-start gap-3 text-black">
                        <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    ...
                    <p className="text-black leading-relaxed mt-3">
                      This may include: name, email address, phone number,
                      company name, job title, and any other information you
                      choose to provide.
                    </p>
                  </div>
              ...
              <div className="flex-1 space-y-4">
                ...
                <ul className="space-y-3 ml-4">
                  <li className="flex items-start gap-3 text-black">
                    <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>
                      <strong className="text-black">Consent:</strong> When you
                  ...
                  <li className="flex items-start gap-3 text-black">
                    <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>
                      <strong className="text-black">Contract:</strong> When
                      processing is necessary to fulfill our contractual
                      obligations
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-black">
              ...
              <div className="flex-1 space-y-4">
                ...
                <ul className="space-y-3 ml-4">
                  ...
                  <li className="flex items-start gap-3 text-black">
                    <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>
                      <strong className="text-black">Business Partners:</strong>{" "}
                      When you request information about partner services or
                      products
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-black">
                    ...
                    <span>
                      ...
                      When required by law, court order, or governmental
                      authority
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-black">
                ...
                <p className="text-black leading-relaxed mt-4 pl-4 border-l-2 border-primary/30">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-black leading-relaxed mt-4">
                  ...
                  <a
                    href="mailto:hello@coreinnovate.co.uk"
                  ...
                  <ul className="space-y-3 ml-4">
                    ...
                    <li className="flex items-start gap-3 text-black">
                      ...
                      <span>
                        ...
                        Used to deliver relevant advertisements (with your
                        consent)
                      </span>
                    </li>
                  </ul>
          ...
          <motion.div
            ...
            className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10"
          >
            <h2 className="text-2xl font-bold font-dm-sans text-black mb-4">
              8. Data Retention
            </h2>
            <p className="text-black leading-relaxed">
              We retain your personal information only for as long as necessary
              to fulfill the purposes outlined in this Privacy Policy, unless a
              longer retention period is required by law. When determining
              retention periods, we consider the nature and sensitivity of the
              information, contractual obligations, legal requirements, and
          ...
          >
            ...
            <p className="text-black leading-relaxed">
              We may use third-party services including Google Analytics,
              reCAPTCHA, email service providers, and cloud hosting providers.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-black leading-relaxed">
              ...
              outside the United Kingdom. When we transfer data internationally,
              we ensure appropriate safeguards are in place, such as standard
              contractual clauses approved by the UK ICO and adequate technical
              measures.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20">
              <p className="text-black leading-relaxed">
                ...
                for data protection issues. Visit{" "}
                <a
