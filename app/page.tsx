	...
	return (
		<div className="space-y-0">
			...
			<div
				...
				<div className="w-full pt-24 lg:pt-50 px-4 sm:px-6 lg:px-8 pb-24 sm:pb-32 lg:pb-40 relative z-20">
						...
						<div className="flex flex-col gap-y-6 sm:gap-y-8 max-w-3xl">
							...
							<motion.div
								...
								<Link href="/contact-us">
									<Button
										className="h-[60px] w-full sm:w-fit shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all"
										size="lg">
										Get Started Today
									</Button>
								</Link>
