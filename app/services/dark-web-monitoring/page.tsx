...
export const metadata: Metadata = {
  ...
  description:
    "Protect your business from credential exposure. 24/7 dark web monitoring to detect compromised credentials and sensitive data before attackers exploit them.",
}
      ...
      <section className="relative bg-gradient-to-b from-red-950 via-slate-900 to-slate-950 text-white py-20 px-4 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mb-8">
            Credential exposure on the dark web is not a theoretical risk. It is
            a real and growing threat that fuels account takeover, ransomware,
            and other cyberattacks before organisations even know they have been
            breached.
          </p>
          <p className="text-lg text-gray-400 max-w-4xl mb-8">
            Dark web monitoring gives you early visibility into compromised
            credentials, sensitive data, and leaked business accounts so you can
            act quickly and decisively to protect your business.
          </p>
          <Link
            href="/contact-us"
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
            <div className="space-y-6">
              <p className="text-lg text-gray-300">
                Stolen credentials are widely traded on underground forums,
                marketplaces, and leak sites. In 2024 alone, an estimated{" "}
              ...
              <p className="text-gray-400">
                Seventy per cent of those users reused their credentials across
                multiple services, amplifying risk dramatically.
              </p>
              <p className="text-gray-400">
                Furthermore, recent research shows there are more than{" "}
                <span className="text-red-400 font-semibold">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-2">
                  These leaked credentials are not simply "data points." They
                  are the primary entry vector threat actors use to breach
                  corporate systems.
                </p>
                <p className="text-gray-400">
                  Industry breach reporting indicates that stolen credentials
                  remain one of the most common initial attack vectors in data
                  breaches.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Dark web monitoring at CORE INNOVATE operates around the
                  clock, scanning criminal marketplaces, forums, and hidden
                  channels for any mention of:
                </p>
                <p className="text-gray-400 mb-6">
                  This continuous surveillance significantly reduces the time
                  between a compromise and detection.
                </p>
                <Link
                  href="/contact-us"
              ...
              <div className="space-y-3">
                {[
                  ...
                  {
                    icon: FileSearch,
                    text: "Proprietary or sensitive business information",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Once compromised credentials are detected, you receive clear
                  alerts so you can take swift action, such as:
                </p>
                <p className="text-gray-400 mb-6">
                  The earlier these issues are identified, the lower the chance
                  of account takeover or lateral movement by attackers.
                </p>
                <Link
                  href="/contact-us"
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Not all dark web data is equally dangerous. Our analysts
                  combine automated threat intelligence with expert review to:
                </p>
                <p className="text-gray-400 mb-6">
                  This ensures you focus on the threats that matter, with
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Modern data breach research continues to confirm the central role
              stolen credentials play in cybercrime:
            </p>
          </div>
          ...
          <p className="text-center text-lg text-gray-300 max-w-3xl mx-auto">
            Dark web monitoring gives you visibility into what attackers already
            have, not just what your defences think they should be protecting.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Cyberattacks are increasingly inevitable. Dark web monitoring
                reduces risk by giving you early warning and actionable
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  icon: Clock,
                  text: "Reduce the window of opportunity for attackers",
                },
                {
                  icon: Activity,
                  text: "Align incident response with real compromise data",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-4 p-6 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 hover:border-red-500/50 transition-all"
                >
                  <div className="p-3 rounded-lg bg-red-500/10 flex-shrink-0">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Dark web monitoring is a critical component of a modern
              cybersecurity strategy. It integrates with identity protection,
              access management, and continuous threat detection to make your
              defences stronger and more responsive.
            </p>
          </div>
          <Link
            href="/contact-us"
