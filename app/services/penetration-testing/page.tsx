...
export const metadata: Metadata = {
  ...
  description:
    "Identify weaknesses before they become incidents. Structured penetration testing that simulates real-world attacks to expose vulnerabilities.",
}
      ...
      <section className="relative bg-gradient-to-b from-red-950 via-slate-900 to-slate-950 text-white py-20 px-4 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mb-8">
            Cyber attacks rarely start with advanced tactics. Most begin by
            exploiting basic weaknesses that remain undiscovered.
          </p>
          <p className="text-lg text-gray-400 max-w-4xl mb-8">
            CORE INNOVATE provides structured penetration testing that simulates
            real-world attack methods to expose vulnerabilities across your
            environment before they are abused. Our service delivers clear
            insight into how an attacker could access your systems, what they
            could reach, and the likely business impact. This allows you to
            reduce risk, protect operations, and maintain trust.
          </p>
          <Link
            href="/contact-us"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Security controls can appear effective while still leaving
              exploitable gaps. Penetration testing validates whether your
              defences actually work under attack conditions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              {
                icon: Search,
                text: "Identify exploitable vulnerabilities across networks, systems, and cloud services",
              },
              {
                icon: Target,
                text: "Understand realistic attack paths and potential impact",
              },
              {
                icon: Shield,
                text: "Reduce exposure to ransomware, data loss, and service disruption",
              },
              {
                icon: FileCheck,
                text: "Support compliance with regulatory and contractual requirements",
              },
            ].map((item, index) => (
              <div
                key={index}
          ...
          <div className="p-8 rounded-xl bg-gradient-to-br from-red-950/50 to-slate-950 border border-red-900/30 text-center mb-8">
            <p className="text-xl text-gray-300 font-semibold">
              This ensures security decisions are based on evidence, not
              assumptions.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Traditional annual testing leaves long periods of exposure. CORE
                INNOVATE offers automated penetration testing that provides
                regular, repeatable assessments without disrupting operations.
              </p>
              <p className="text-cyan-300 font-semibold mb-8">
                This approach delivers enterprise-level coverage at a controlled
            ...
            <div className="space-y-4">
              {[
                {
                  icon: Activity,
                  text: "Internal and external attack simulations",
                },
                {
                  icon: Zap,
                  text: "Continuous testing rather than point-in-time checks",
                },
                {
                  icon: FileCheck,
                  text: "Consistent reporting with prioritised remediation actions",
                },
                {
                  icon: TrendingUp,
                  text: "Suitable for small, medium, and regulated organisations",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-4 p-4 rounded-lg bg-slate-900/50 border border-slate-800 hover:border-cyan-500/50 transition-colors"
                >
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Our penetration testing replicates attacker behaviour using
              current threat intelligence and proven exploitation techniques.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              {
                icon: Network,
                text: "External testing of internet-facing systems",
                color: "red",
              },
              {
                icon: Server,
                text: "Internal testing to assess lateral movement and privilege escalation",
                color: "orange",
              },
              {
                icon: Lock,
                text: "Credential misuse and misconfiguration analysis",
                color: "amber",
              },
              {
                icon: AlertTriangle,
                text: "Patch gaps and insecure access paths",
                color: "red",
              },
            ].map((item, index) => (
              <div
          ...
          <div className="p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 text-center mb-8">
            <p className="text-lg text-gray-300">
              Each finding is clearly documented with risk level, impact, and
          ...
          <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 mb-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Identifying weaknesses is only valuable if action follows. We
                help you respond effectively when critical issues are uncovered.
              </p>
              <p className="text-blue-300 font-semibold mb-6">
                This ensures vulnerabilities are resolved before they escalate
                into incidents.
              </p>
              <Link
                href="/contact-us"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 mb-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Effective security requires alignment between technology,
                people, and processes. Penetration testing provides real data to
                support this.
              </p>
              <p className="text-purple-300 font-semibold mb-6">
                Testing becomes part of a structured security programme rather
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 mb-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Penetration testing is often required for audits, insurance, and
                supplier assurance. Our service supports regulatory and industry
                standards.
              </p>
              <p className="text-emerald-300 font-semibold mb-6">
                Higher-tier services include ongoing testing and
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Penetration testing with CORE INNOVATE delivers:
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                icon: FileCheck,
                text: "Actionable insight for technical and leadership teams",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 hover:border-red-500/50 transition-all text-center"
              >
          ...
          <p className="text-center text-lg text-gray-300 mt-8">
            It is a practical investment in resilience and operational
            stability.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-gradient-to-b from-slate-950 to-red-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Protect your systems, data, and operations by identifying weaknesses
            before attackers do.
          </p>
          <Link
            href="/contact-us"
