...
export const metadata: Metadata = {
  ...
  description:
    "Modern infrastructure designed for scale, security, and performance. Design, upgrade, and operate resilient edge-to-cloud environments.",
}
    ...
    <main className="min-h-screen bg-slate-950 pt-20">
      ...
      <section className="relative bg-gradient-to-b from-blue-950 via-slate-900 to-slate-950 text-white py-20 px-4 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mb-8">
            Legacy infrastructure limits growth, increases risk, and drives
            unnecessary cost. Modern businesses need flexible, secure, and
            scalable platforms that support cloud adoption, hybrid environments,
            and evolving operational demands.
          </p>
          <p className="text-lg text-gray-400 max-w-4xl">
            CORE INNOVATE delivers Infrastructure and Modernisation services
            that help organisations design, upgrade, and operate resilient
            edge-to-cloud environments. We focus on practical modernisation that
            improves performance, strengthens security, and supports long-term
            business objectives.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              We support organisations at every stage of growth, from scaling
              businesses to complex enterprise environments.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    We design and deliver infrastructure solutions that are
                    reliable, secure, and built to evolve.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              CORE INNOVATE provides end-to-end infrastructure services covering
          ...
          <div className="space-y-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  We modernise on-premise and hosted environments to improve
                  performance, resilience, and manageability.
                </p>
              </div>
              <div className="space-y-3">
                {[
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Not every workload belongs in the cloud. We design hybrid
                  architectures that balance performance, cost, and control.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Virtualisation improves efficiency and resilience when
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-400">
                  This links directly with our Backup, Disaster Recovery, and
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Infrastructure is only as strong as the network that connects
                  it.
                </p>
                <p className="text-gray-400">
                  Connectivity is designed with performance and security in
                  mind.
                </p>
              </div>
              <div className="space-y-3">
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Infrastructure decisions directly affect security posture. Our
              designs:
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[
              {
                icon: FileCheck,
                text: "Align with regulatory and compliance requirements",
              },
              {
                icon: Lock,
                text: "Support secure access and identity controls",
              },
              {
                icon: Shield,
                text: "Integrate with SOC, endpoint, and monitoring services",
              },
            ].map((item, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              ...
              <p className="text-gray-300 mb-4">
                We design infrastructure based on business outcomes, not vendor
                checklists.
              </p>
            ...
            <div className="p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              ...
              <p className="text-gray-300 mb-4">
                We work with leading infrastructure and cloud technology
                providers to deliver secure and supported solutions.
              </p>
              <div className="space-y-2">
                {[
                  "Proven platforms",
              ...
              <p className="text-gray-400 text-sm mt-4">
                Technology choices are driven by suitability, not brand
                preference.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[
              ...
              },
              {
                ...
                desc: "Monitoring and protection",
                icon: Shield,
              },
              {
                title: "Compliance Services",
                desc: "Governance and assurance",
                icon: FileCheck,
              },
            ].map((item, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-slate-900 border border-slate-800 hover:border-blue-500/50 transition-all text-center"
              >
          ...
          <p className="text-center text-gray-400">
            This ensures infrastructure supports the wider IT and security
            strategy.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-gradient-to-b from-slate-950 to-blue-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-4">
            If you are planning to modernise infrastructure, migrate workloads,
            or improve resilience, we can help assess the right approach.
          </p>
          <p className="text-gray-400 mb-8">
            Receive tailored advice to strengthen and modernise your IT
            infrastructure.
          </p>
          <Link
            href="/contact-us"
