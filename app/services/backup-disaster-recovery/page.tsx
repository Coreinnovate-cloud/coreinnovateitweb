...
export const metadata: Metadata = {
  title:
    "Data Backup, Disaster Recovery & Business Continuity | CoreInnovate IT",
  description:
    "Recover faster. Reduce downtime. Protect your business with secure, managed backup and disaster recovery solutions.",
}
      ...
      <section className="relative bg-gradient-to-b from-cyan-950 via-slate-900 to-slate-950 text-white py-20 px-4 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mb-8">
            Data loss remains one of the most disruptive events a business can
            face. Ransomware, system failure, human error, and hardware faults
            can all bring operations to a halt if reliable backups and recovery
            plans are not in place.
          </p>
          <p className="text-lg text-gray-400 max-w-4xl">
            CORE INNOVATE delivers secure, managed backup and disaster recovery
            solutions designed to protect critical data, support rapid recovery,
            and maintain business continuity when incidents occur.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Without proper backups, organisations are often left with two
              options during an attack: accept prolonged downtime or pay a
              ransom with no guarantee of recovery.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Accept prolonged downtime or pay ransom with no recovery
                    guarantee
                  </p>
                </div>
              </div>
            ...
            <div className="p-8 rounded-xl bg-gradient-to-br from-cyan-950/50 to-slate-950 border border-cyan-900/30">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Recovery certainty and operational resilience
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: Shield,
                text: "Reduces the impact of ransomware and cyber incidents",
              },
              {
                icon: Zap,
                text: "Enables rapid restoration of systems and data",
              },
              {
                icon: FileCheck,
                text: "Supports compliance and data protection obligations",
              },
              {
                icon: TrendingUp,
                text: "Improves resilience and operational confidence",
              },
            ].map((item, index) => (
              <div
                key={index}
          ...
          <div className="space-y-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-400">
                  Backups are securely stored and managed to ensure integrity
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">
                    Designed for Compliance and Retention
                  </h3>
                </div>
                <p className="text-gray-300 mb-4">
                  Backup and retention requirements vary by industry and
                  regulation.
                </p>
                <p className="text-gray-400">
                  This aligns directly with our Compliance as a Service
                  offering.
                </p>
              </div>
              <div className="space-y-3">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                ...
                <p className="text-gray-400">
                  This service integrates with our Managed IT and Cyber Security
                  services to ensure recovery plans align with real-world risks.
                </p>
              </div>
              <div className="space-y-3">
                {[
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: RotateCcw,
                text: "Reliable recovery from cyber incidents and data loss",
              },
              ...
              {
                icon: CheckCircle2,
                text: "Confidence that data can be restored when it matters",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Data backup and recovery does not operate in isolation. At CORE
              INNOVATE, it integrates with:
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "System governance",
                icon: Server,
              },
              {
                title: "SOC & Endpoint Security",
                desc: "Incident response",
                icon: Shield,
              },
              {
                title: "Compliance Services",
                desc: "Retention and evidence",
                icon: FileCheck,
              },
              {
                title: "Security Monitoring",
                desc: "Early threat detection",
                icon: Activity,
              },
            ].map((item, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-slate-900 border border-slate-800 hover:border-cyan-500/50 transition-all text-center"
              >
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-gradient-to-b from-slate-950 to-cyan-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            If you want a clear view of your current risk, resilience, and
            recovery readiness, we can help.
          </p>
          <Link
            href="/contact-us"
