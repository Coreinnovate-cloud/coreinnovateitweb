...
import { Server, Shield, Clock, Eye, Users, CheckCircle2, AlertTriangle, Zap, Target, Activity, Lock, FileCheck, TrendingUp, Layers, Settings } from "lucide-react";

export const metadata: Metadata = {
  title: "Managed IT Services | CoreInnovate IT",
  description: "Secure, proactive IT management built for modern risk. 20-minute response time, security embedded by design, and compliance as a natural outcome.",
};
    ...
    <main className="min-h-screen bg-slate-950 pt-20">
      ...
      <section className="relative bg-gradient-to-b from-blue-950 via-slate-900 to-slate-950 text-white py-20 px-4 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mb-8">
            Traditional managed IT focuses on fixing problems after they occur. Core Innovate IT takes a different approach. We manage IT with security, risk reduction, and operational stability built in from day one.
          </p>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              { icon: AlertTriangle, text: "Security gaps that remain undetected", color: "red" },
              { icon: Clock, text: "Downtime discovered after business impact", color: "orange" },
              { icon: Zap, text: "Slow response during critical incidents", color: "amber" },
              { icon: FileCheck, text: "Compliance based on paperwork rather than real controls", color: "red" }
            ].map((item, index) => (
          ...
          <div className="p-8 rounded-xl bg-gradient-to-br from-blue-950/50 to-slate-950 border border-blue-900/30 text-center">
            ...
            <p className="text-xl text-gray-300 font-semibold">
              Core Innovate IT addresses these issues through a fundamentally different service design.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              How Core Innovate IT Delivers Managed IT
            </h2>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Security Embedded by Design</h3>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Proactive Risk Management, Not Ticket Chasing</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-emerald-950/50 to-slate-950 border border-emerald-900/30">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">20-Minute Response Time for Critical Issues</h3>
                </div>
                <p className="text-gray-300 mb-4">
                  When issues do occur, speed matters.
                </p>
                <p className="text-gray-300 mb-4">
                  Core Innovate IT provides a <span className="text-emerald-400 font-bold">20-minute response time</span> for priority incidents, ensuring problems are acknowledged, triaged, and actively worked on without delay.
                </p>
              ...
              <div className="flex items-center justify-center">
                <div className="p-8 rounded-xl bg-emerald-500/5 border border-emerald-500/20 text-center">
                  <div className="text-6xl font-bold text-emerald-400 mb-2">20</div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Identity-First IT Management</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Integrated IT and Security Operations</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Evidence-Based Service Delivery</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Compliance as a Natural Outcome</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Designed to Scale Without Redesign</h3>
                </div>
                <p className="text-gray-300 mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Clear Ownership and Commercial Transparency</h3>
                </div>
                <p className="text-gray-300 mb-4">
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              What You Gain From Managed IT With Core Innovate IT
            </h2>
          </div>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12 bg-gradient-to-b from-slate-950 to-blue-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            If you want IT that is secure by design, proactively managed, and supported with a 20-minute response time, Core Innovate IT can help.
          </p>
          <Link
            href="/contact-us"
