...
import { AlertCircle, FileText, Lock, Scale, Shield } from "lucide-react"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="pl-4 border-l-2 border-primary/30">
                ...
                <p className="text-grey leading-relaxed">
                  When these terms mention &quot;Company,&quot; &quot;we,&quot;
                  &quot;us,&quot; or &quot;our,&quot; it refers to Core Innovate
                  IT Ltd (Suite 248, Corinium House, Barnwood Business Park,
                  Gloucester, GL4 3HX, United Kingdom), which is responsible for
                ...
                <ul className="space-y-2 ml-4">
                  <li className="flex items-start gap-3 text-grey">
                    ...
                    <span>
                      ...
                      host, outsource, disclose or otherwise commercially
                      exploit the website or make the platform available to any
                      third party
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-grey">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-grey leading-relaxed">
                  ...
                  design, selection and arrangement thereof), are owned by Core
                  Innovate IT, its licensors or other providers of such material
                  and are protected by United Kingdom and international
                ...
                <p className="text-grey leading-relaxed">
                  ...
                  without the express prior written permission of Core Innovate
                  IT, unless and except as is expressly provided in these Terms
