...
const ResourcesPage = () => {
	...
	return (
		<div className="space-y-16 overflow-hidden">
			...
			<div className="relative bg-gradient-to-br from-dark via-secondary to-dark min-h-[400px] sm:min-h-[500px] flex items-center px-4 sm:px-8 lg:px-12 overflow-hidden pt-24 lg:pt-48">
				...
				<motion.div
					...
					<motion.p
						...
						className="text-white/70 max-w-[90%] sm:max-w-[650px] text-base sm:text-lg px-4 leading-relaxed mb-30">
						Get the latest insights, industry updates, and expert advice
						designed to keep your business{" "}
